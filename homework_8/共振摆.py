...
class EULER(object):
    def __init__(self, _theta0=10., _omg0=0, _t0=0., _l=1.,_g=9.8, _dt=0.01, _time=10.):
    ...
    def calculate(self):
	    ...
	    self.omg.append(self.omg[-1]-self.g/self.l*self.theta[-1]*self.dt-self.omg[-1]*self.dt+0.2*np.sin(3.13*self.t[-1])*self.dt)
